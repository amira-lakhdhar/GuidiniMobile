 ...
 * @author amira
 */
public class ListePharmacy extends BaseForm{
      Form current;

    public ListePharmacy(Resources res){
        
        super("Liste Pharmacy",BoxLayout.y());
        
        Toolbar tb = new Toolbar(true);
        current = this;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Liste des Pharmacie");
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Pharmacies", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Partager", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Pharmacies", barGroup);
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&display=popup&ref=plugin&src=share_button");
        ...
        ArrayList<Pharmacy>list = Service_Pharmacy.getInstance().findAll();
        
        for(Pharmacy art:list){
    ...
    private void addButton(Image img, Pharmacy art,Resources res) {
        ...
        Label titreTxt = new Label("nom : "+art.getName(),"NewsTopLine2");
        
            Label titreTxt2 = new Label("Phone : "+art.getPhone(),"NewsTopLine2");

              Label titreTxt3 = new Label("Email : "+art.getEmail(),"NewsTopLine2");
              

              Label titreTxt4 = new Label("Hourly : "+art.getHourly(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce Cours ?","Annuler","Oui")){
                ...
                if(Service_Pharmacy.getInstance().deletePharmacy(art.getId())){
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
         new MofidierPharmacie(res, art).show();
