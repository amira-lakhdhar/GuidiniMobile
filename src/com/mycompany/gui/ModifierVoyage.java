 ...
 * @author amira
 */
public class ModifierVoyage extends BaseForm{
    Form current;

    public ModifierVoyage(Resources res, Voyage rec) {
...
tb.addSearchCommand(e -> {
       ...
       // TextField LPD = new TextField(rec.getPrixlpd(), "LPD", 20, TextField.ANY);
        ...
        btnModifier.addPointerPressedListener(l -> {
          ...
          rec.setPrix(Float.valueOf(prix.getText()));
       

            if (service_voyage.getInstance().ModifierVoyage(rec)) {
