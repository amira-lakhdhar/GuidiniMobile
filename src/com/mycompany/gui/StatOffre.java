...
public class StatOffre {
     ...
     */
    protected CategorySeries buildCategoryDataset(String title, ArrayList<Offre> ab) {
        CategorySeries series = new CategorySeries(title);

        for (Offre u : ab) {
            series.add(u.getNom(), u.getPourcentage());
  ...
  //stat  
    public void createPieChartForm(String titre, ArrayList<Offre> ab,Resources res) {
        // Generate the values
