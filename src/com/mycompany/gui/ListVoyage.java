 ...
 * @author amira
 */
public class ListVoyage extends BaseForm {
    Form current;

    public ListVoyage(Resources res){
        
        super("Liste Voyage",BoxLayout.y());
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Voyage", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Partager", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Voyages", barGroup);
...
//Api 
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&display=popup&ref=plugin&src=share_button");
        ...
        ArrayList<Voyage>list = service_voyage.getInstance().findAll();
    ...
    private void addButton(Image img, Voyage art,Resources res) {
        ...
        Label titreTxt = new Label("Description : "+art.getDescription(),"NewsTopLine2");
        
            Label titreTxt2 = new Label("Prix : "+art.getPrix(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette Offre ?","Annuler","Oui")){
               ...
               if(service_voyage.getInstance().deletevoyage(art.getId())){
                    new ListVoyage(res).show();
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
         new ModifierVoyage(res, art).show();
