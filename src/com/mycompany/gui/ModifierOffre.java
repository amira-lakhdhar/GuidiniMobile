...
public class ModifierOffre extends BaseForm{
    ...
    public ModifierOffre(Resources res, Offre rec) {
...
tb.addSearchCommand(e -> {
       ...
       // TextField LPD = new TextField(rec.getPrixlpd(), "LPD", 20, TextField.ANY);
         ...
         TextField name = new TextField(rec.getNom(), "Nom", 20, TextField.ANY);
      
         TextField Pourcentage = new TextField(String.valueOf(rec.getPourcentage()), "Pourcentage", 20, TextField.ANY);
        ...
        btnModifier.addPointerPressedListener(l -> {
          ...
          rec.setPourcentage(Integer.valueOf(Pourcentage.getText()));
       

            if (Service_Offre.getInstance().ModifierOffre(rec)) {
