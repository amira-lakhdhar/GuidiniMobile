 ...
 * @author amira
 */
public class ListeOffre extends BaseForm {
    Form current;

    public ListeOffre(Resources res){
        
        super("Liste Offres",BoxLayout.y());
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Offres", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Partager", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Offres", barGroup);
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&display=popup&ref=plugin&src=share_button");
        ...
        ArrayList<Offre>list = Service_Offre.getInstance().findAll();
    ...
    private void addButton(Image img, Offre art,Resources res) {
        ...
        Label titreTxt = new Label("Nom : "+art.getNom(),"NewsTopLine2");
        
            Label titreTxt2 = new Label("Pourcentage : "+art.getPourcentage(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette Offre ?","Annuler","Oui")){
               ...
               if(Service_Offre.getInstance().deleteOffre(art.getId())){
                    new ListeOffre(res).show();
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
         new ModifierOffre(res, art).show();
